...
{
    options.UseSqlServer(builder.Configuration.GetConnectionString("Licitacion"));
});

builder.Services.AddScoped<ILicitationRepository, LicitationRepository>();
builder.Services.AddScoped<IServiceCall<Decision>, ServiceCall<Decision>>();
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Licitation API",
        Version = "v1",
        Description = "An API to perform Licitation operations",
...
builder.Services.AddGoogleDiagnosticsForAspNetCore("licitation", "URIS_Licitation_IT67-2019", "1.0.0");
