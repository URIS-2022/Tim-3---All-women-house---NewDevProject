...
{
    options.UseSqlServer(builder.Configuration.GetConnectionString("Ministry"));
});
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        Title = "Ministry API",
        Version = "v1",
        Description = "An API to perform Ministry operations",
...
builder.Services.AddGoogleDiagnosticsForAspNetCore("ministry-378110", "URIS_Ministry_IT67-2019", "1.0.0");
